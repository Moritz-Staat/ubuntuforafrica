      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-10 border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} UBUNTU for Africa Kinder, Jugend- und Familienhilfe e.V. · Gemeinnützig eingetragen
          </p>
          <div className="flex gap-6 text-xs">
            <Link href="/impressum" className="text-gray-500 hover:text-[#11aed1] transition-colors">
              {t('legal')}
            </Link>
